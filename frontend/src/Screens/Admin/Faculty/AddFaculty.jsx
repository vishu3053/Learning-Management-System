  ...
  const sendEmail = async () => {
    try {
      const templateParams = {
        facultyname: data.firstName,
        to: data.email,
        enrollmentnumber: data.employeeId,
      };
      const result = await emailjs.send('service_6iw3a5k', 'template_smqt6hq', templateParams, '-HQ_08N7f1ml_-oOK');
      ...
      <div className="w-[95%] flex justify-evenly items-center">
        ...
        <div className="w-[25%]">
          <label htmlFor="experience" className="leading-7 text-sm ">
            Enter Experience<span className="text-red-500">*</span>
          </label>
          <input
            type="number"
            id="experience"
